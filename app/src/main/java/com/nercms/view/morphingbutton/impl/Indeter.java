package com.nercms.view.morphingbutton.impl;
...
import com.nercms.R;
import com.nercms.view.morphingbutton.MorphingAnimation;
import com.nercms.view.morphingbutton.MorphingButton;

/**
 * Created by zsg on 2016/7/14.
 */
public class Indeter {
 /*   private int mColor1;
    private int mColor2;
    private int mColor3;
    private int mColor4;
    ...
    public Indeter(Context context) {
        super(context);
        init(context);
    }
